...
project = project = 'AlbireoLib'
copyright = '{0}, {1}'.format('2017', 'José Sánchez-Gallego')
...
html_theme_options = {
    'logo': 'sdss_logo.png',
    'github_user': 'albireox',
    'github_repo': 'albireolib',
    'github_button': True,
    'github_type': 'star',
...
htmlhelp_basename = '{0}pdoc'.format('albireolib')
...
man_pages = [
    (master_doc, 'albireolib', u'{0} Documentation'.format(project),
     [author], 1)
]
